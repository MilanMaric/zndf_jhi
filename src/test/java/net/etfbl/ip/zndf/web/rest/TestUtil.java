...
import static net.etfbl.ip.zndf.config.JacksonConfiguration.ISO_DATE_OPTIONAL_TIME;
import static net.etfbl.ip.zndf.config.JacksonConfiguration.ISO_FIXED_FORMAT;
