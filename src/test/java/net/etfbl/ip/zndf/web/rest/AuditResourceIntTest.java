...
import net.etfbl.ip.zndf.ZndfApp;
import net.etfbl.ip.zndf.config.audit.AuditEventConverter;
import net.etfbl.ip.zndf.domain.PersistentAuditEvent;
import net.etfbl.ip.zndf.repository.PersistenceAuditEventRepository;
import net.etfbl.ip.zndf.service.AuditEventService;
...
@SpringBootTest(classes = ZndfApp.class)
@Transactional
